...
const Datepicker = ({ primaryColor = "blue", value = null, onChange, useRange = true, showFooter = false, showShortcuts = false, configs = undefined, asSingle = false, placeholder = null, separator = "~", startFrom = null, i18n = LANGUAGE, disabled = false, inputClassName = null, containerClassName = null, toggleClassName = null, toggleIcon = undefined, displayFormat = DATE_FORMAT, readOnly = false, minDate = null, maxDate = null, dateLooking = "forward", disabledDates = null, inputId, inputName, startWeekOn = "sun", classNames = undefined, popoverDirection = undefined, inline = false, reverse = false, hideForm = false }) => {
    ...
    return (React.createElement(DatepickerContext.Provider, { value: contextValues },
        React.createElement("div", { className: containerClassNameOverload, ref: containerRef },
            !hideForm && React.createElement(Input, { setContextRef: setInputRef }),
            React.createElement("div", { className: `transition-all ease-out duration-300  z-10 mt-[1px] text-sm lg:text-xs 2xl:text-sm translate-y-4 ${inline ? "" : "opacity-0 hidden absolute"}`, ref: calendarContainerRef },
                !inline && React.createElement(Arrow, { ref: arrowRef }),
                React.createElement("div", { className: "mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg" },
                    React.createElement("div", { className: `flex flex-col ${reverse ? "lg:flex-row-reverse" : "lg:flex-row"} py-2` },
