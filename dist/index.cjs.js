    ...
    const buttonClass = React.useCallback((day, type) => {
        ...
        if (type === "current") {
            return classNames(baseClass, !activeDateData(day).active
                ? hoverClassByDay(day)
                : activeDateData(day).className, isDateDisabled(day, type) && "text-[#ddd] cursor-not-allowed");
        }
        return classNames(baseClass, isDateDisabled(day, type) && "text-[#ddd] cursor-not-allowed", "text-gray-400");
...
const Datepicker = ({ primaryColor = "blue", value = null, onChange, useRange = true, showFooter = false, showShortcuts = false, configs = undefined, asSingle = false, placeholder = null, separator = "~", startFrom = null, i18n = LANGUAGE, disabled = false, inputClassName = null, containerClassName = null, toggleClassName = null, toggleIcon = undefined, displayFormat = DATE_FORMAT, readOnly = false, minDate = null, maxDate = null, dateLooking = "forward", disabledDates = null, inputId, inputName, startWeekOn = "sun", classNames = undefined, popoverDirection = undefined, inline = false, reverse = false, hideForm = false }) => {
    ...
    return (React__default["default"].createElement(DatepickerContext.Provider, { value: contextValues },
        React__default["default"].createElement("div", { className: containerClassNameOverload, ref: containerRef },
            !hideForm && React__default["default"].createElement(Input, { setContextRef: setInputRef }),
            React__default["default"].createElement("div", { className: `transition-all ease-out duration-300  z-10 mt-[1px] text-sm lg:text-xs 2xl:text-sm translate-y-4 ${inline ? "" : "opacity-0 hidden absolute"}`, ref: calendarContainerRef },
                !inline && React__default["default"].createElement(Arrow, { ref: arrowRef }),
                React__default["default"].createElement("div", { className: "mt-2.5 shadow-sm border border-gray-300 px-1 py-0.5 bg-white dark:bg-slate-800 dark:text-white dark:border-slate-600 rounded-lg" },
                    React__default["default"].createElement("div", { className: `flex flex-col ${reverse ? "lg:flex-row-reverse" : "lg:flex-row"} py-2` },
